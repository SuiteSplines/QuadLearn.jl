...
for q = [2,3,4]
    for R = collect(1.0:1.0:50.0)
        for case = 1:15
            # choose wheter to load an existing model or train a new model
            train = true

            #q = 2     # polynomial degree of the target space for quadrature
            #p = 4     # polynomial degree of the spline interpolations space
            #R = 21.0   # radius interval [R, R + 1.0], note: Float64(R) === Int(R)!
            #case = 10 # selected cut case 
            p = q*q
            ...
            if train == true
                @info "Training $filename_specifier"
                ...
                if case == 1
                    ...
                    model, traindata,  testdata = train_model(;
                        ...
                        θ̂=refined_increasing_vector(n=(20,), p_l=(4.0,), p_r=(1.0,), breakpoints=(0.0, 1.0)),
                        ẑ=refined_increasing_vector(n=(20,), p_l=(4.0,), p_r=(1.0,), breakpoints=(0.0, 1.0)),
                        case=1
                    )
                ...
                elseif case == 2
                    ...
                    model, traindata,  testdata = train_model(;
                        ...
                        interp_p=4,
                        R=IncreasingRange(R, R+1.0, 10),
                        θ̂=refined_increasing_vector(n=(20,), p_l=(1.0,), p_r=(6.0,), breakpoints=(0.0, 1.0)),
                        ẑ=refined_increasing_vector(n=(20,), p_l=(6.0,), p_r=(1.0,), breakpoints=(0.0, 1.0)),
                        case=2
                    )
                ...
                elseif case == 4
                    ...
                    model, traindata,  testdata = train_model(;
                        ...
                        interp_p=4,
                        R=IncreasingRange(R, R+1.0, 10),
                        θ̂=refined_increasing_vector(n=(20,), p_l=(1.0,), p_r=(1.0,), breakpoints=(0.0, 1.0)),
                        ẑ=refined_increasing_vector(n=(20,), p_l=(1.0,), p_r=(4.0,), breakpoints=(0.0, 1.0)),
                        case=4
                    )
                ...
                elseif case == 5
                    ...
                    model, traindata,  testdata = train_model(;
                        ...
                        interp_p=4,
                        R=IncreasingRange(R, R+1.0, 10),
                        θ̂=refined_increasing_vector(n=(20,), p_l=(1.5,), p_r=(1.0,), breakpoints=(0.0, 1.0)),
                        ẑ=refined_increasing_vector(n=(20,), p_l=(1.0,), p_r=(1.0,), breakpoints=(0.0, 1.0)),
                        case=5
                    )
                ...
                elseif case == 8
                    ...
                    model, traindata,  testdata = train_model(;
                        ...
                        interp_p=4,
                        R=IncreasingRange(R, R+1.0, 10),
                        θ̂=refined_increasing_vector(n=(20,), p_l=(1.0,), p_r=(2.0,), breakpoints=(0.0, 1.0)),
                        ẑ=refined_increasing_vector(n=(20,), p_l=(1.0,), p_r=(2.0,), breakpoints=(0.0, 1.0)),
                        case=8
                    )
                ...
                elseif case == 11
                    ...
                    model, traindata,  testdata = train_model(;
                        ...
                        interp_p=4,
                        R=IncreasingRange(R, R+1.0, 10),
                        θ̂=refined_increasing_vector(n=(10,), p_l=(2.0,), p_r=(1.0,), breakpoints=(0.0, 1.0)),
            ...
            @test isapprox(norm(y_train - traindata.y), 0.0; atol=1e-13)
